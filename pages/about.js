  ...
  return (<>
    ...
    <div className="bg-black w-full min-h-screen py-64 flex flex-col space-y-32 items-center justify-center">
      <div className="flex flex-col items-center justify-center space-y-8">    
        ...
        <h1 className="text-headline text-white text-center font-semibold max-w-3xl" ref={addToRefs}>
      ...
      <div className="flex flex-col items-center justify-center space-y-8">
        <svg height="96" width="96" viewBox="-2 -2 100 100" ref={icoMushroom}>
        ...
        <h1 className="text-headline text-white text-center font-semibold max-w-2xl" ref={addToRefs}>
